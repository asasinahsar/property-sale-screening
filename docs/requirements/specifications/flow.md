...
| P001 ダッシュボード | 全体把握・ランキング閲覧・選定起点 | P000, P002, P003 | P002, P003, P000, P004（Phase2） | 企業行クリック→P002／「ロングリストに追加」→P003／ログアウト→P000／ウォッチ登録→P004（Phase2） |
...
> 点線（-.->）は **Phase2** の遷移。Phase1（Sprint3 MVP）では P000〜P003 のみを提供する。
...
- スクリーニング実行は独立画面を持たず、P001 のボタンとして配置（P005相当は不要）
